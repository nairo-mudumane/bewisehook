    ...
    if (body_param.object) {
        if (body_param.entry && 
            ...
            // body_param.entry[0].changes.value.messages[0]
                ...
                var review =  changes.messages.map((message)=>message.text.body).join('\n\n'),
...
async function sendMessage(message, to, phone_id) {
    var BASE_URL = "https://graph.facebook.com/v15.0/"+phone_id+"/messages?access_token="+token;
    
    var data = { "messaging_product": "whatsapp", "to": "258843655568", "type": "template", "template": { "name": "hello_world", "language": { "code": "en_US" } } }
